...
final class DiscoverController extends Controller {
	 ...
	 */
	#[NoCSRFRequired]
	#[FrontpageRoute(verb: 'GET', url:'/api/v1/discover')]
	 ...
	 * @return FileDisplayResponse<Http::STATUS_OK, array{'Content-Type': string}>|NotFoundResponse<Http::STATUS_BAD_REQUEST|Http::STATUS_NOT_FOUND, array{}>
	 */
	#[NoCSRFRequired]
