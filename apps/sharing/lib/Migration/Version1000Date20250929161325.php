...
final class Version1000Date20250929161325 extends SimpleMigrationStep {
	...
	public function changeSchema(IOutput $output, Closure $schemaClosure, array $options): ?ISchemaWrapper {
		...
		$sourcesTable->addUniqueConstraint(['id', 'source_type', 'source_value']);
		...
		$recipientsTable->addUniqueConstraint(['id', 'recipient_type', 'recipient_value']);
		...
		$propertiesTable->addUniqueConstraint(['id', 'property_type']);
		...
		$permissionsTable->addUniqueConstraint(['id', 'permission_type']);

		// TODO: Add primary keys and indices
