...
use OCP\Sharing\ISharePropertyModifyValue;
	...
	private function list(ShareAccessContext $accessContext, ?string $filterShareID, ?string $filterSourceType, ?string $lastShareID, ?int $limit): array {
		...
		foreach ($queries as $qb) {
			...
			foreach ($rows as $row) {
				...
				$shares[$id] ??= [
					'id' => (string)$id,
					'owner' => new ShareOwner((string)$row['owner']),
		...
		/** @var array<non-empty-string, array<class-string<IShareSourceType>, bool>> $shareSourceTypes */
		$shareSourceTypes = [];
		...
		/** @var array<non-empty-string, array<class-string<IShareRecipientType>, bool>> $shareRecipientTypes */
		$shareRecipientTypes = [];
		foreach ($chunks as $chunk) {
		...
		/** @var array<class-string<IShareProperty>, list<class-string<IShareSourceType>>> $propertyCompatibleSourceTypes */
		$propertyCompatibleSourceTypes = [];
		/** @var array<class-string<IShareProperty>, list<class-string<IShareRecipientType>>> $propertyCompatibleRecipientTypes */
